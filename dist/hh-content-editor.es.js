...
function ur() {
  ...
  function S(b, l, R) {
    ...
    R !== void 0 && (_ = '' + R),
      ...
      l.ref !== void 0 && (A = l.ref);
    for (v in l) y.call(l, v) && !D.hasOwnProperty(v) && (E[v] = l[v]);
    if (b && b.defaultProps)
      for (v in ((l = b.defaultProps), l)) E[v] === void 0 && (E[v] = l[v]);
    return {
      $$typeof: P,
      type: b,
      key: _,
          ...
          function Ze(e, r, t, n, i) {
            {
              ...
              return Xe(e, a, d, i, n, x.current, o);
            }
          }
          var G = T.ReactCurrentOwner,
            Ee = T.ReactDebugCurrentFrame;
          function O(e) {
            if (e) {
              var r = e._owner,
                t = W(e.type, e._source, r ? r.type : null);
          ...
          function me(e, r, t, n, i, u) {
            {
              ...
              if (o) {
                ...
                if (p !== void 0)
                  if (n)
                    if (q(p)) {
                      for (var C = 0; C < p.length; C++) _e(p[C], e);
...
const lr = () =>
    /* @__PURE__ */ Ce.jsx('div', {
      children: '這是 Editor 元件',
    }),
  cr = () =>
    /* @__PURE__ */ Ce.jsx('div', {
      children: '這是 Foo 元件',
    });
export { lr as Editor, cr as Foo };
//# sourceMappingURL=hh-content-editor.es.js.map
